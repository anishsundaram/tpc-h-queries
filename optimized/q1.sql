...
/*Q1 computes eight aggregates: a count, four sums and three averages. Using 
EXPLAIN ANALYZE we can see that there is a sequential scan done on the lineitem
table for the shipping dates mentioned in the WHERE clause. By indexing this we
 can cut down on this scan and increase speed for a tradeoff in space. */

CREATE INDEX idx_shipdate ON lineitem USING BRIN (l_shipdate);
Select
    l_returnflag,
    l_linestatus,
